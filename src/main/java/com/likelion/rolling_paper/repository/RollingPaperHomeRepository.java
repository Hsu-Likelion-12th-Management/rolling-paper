...
import com.likelion.rolling_paper.home.exception.RollingPaperHomeNotFoundException;
...
public interface RollingPaperHomeRepository extends JpaRepository<RollingPaperHome,Long> {
    default RollingPaperHome getById(Long id) {
        return findById(id).orElseThrow(RollingPaperHomeNotFoundException::new);
    }
}
