...
public interface HomeService {
    Long createRollingPaperHome(String kakaoId, CreateHomeReqDto createHomeReqDto);
    List<GetMyRollingPaperHomeRes> getMyRollingPaperHomes(String kakaoId, Pageable pageable);
}
